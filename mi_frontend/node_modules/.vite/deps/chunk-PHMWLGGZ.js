...
var OutlinedInput = React34.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  const [NotchedSlot, notchedProps] = useSlot("notchedOutline", {
    ...
    additionalProps: {
      label: label != null && label !== "" && fcs.required ? (0, import_jsx_runtime22.jsxs)(React34.Fragment, {
        children: [label, " ", "*"]
      }) : label
    }
  });
...
var elementAcceptingRef = chainPropTypes(import_prop_types32.default.element, acceptingRef);
  ...
  return (0, import_jsx_runtime40.jsx)(FormControlContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime40.jsx)(InputAdornmentRoot, {
      ...
      children: typeof children2 === "string" && !disableTypography ? (0, import_jsx_runtime40.jsx)(Typography_default, {
        color: "textSecondary",
        children: children2
      }) : (0, import_jsx_runtime40.jsxs)(React55.Fragment, {
...
var ButtonGroupButtonContext = React60.createContext(void 0);
if (true) {
...
var Button = React61.forwardRef(function Button2(inProps, ref) {
  const contextProps = React61.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React61.useContext(ButtonGroupButtonContext_default);
...
var DialogActions = React62.forwardRef(function DialogActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiDialogActions"
  });
...
var Chip = React67.forwardRef(function Chip2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React67.useRef(null);
  ...
  const ownerState = {
    ...
    size,
    color,
    iconColor: React67.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  };
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && React67.isValidElement(deleteIconProp) ? React67.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && React67.isValidElement(avatarProp)) {
    avatar = React67.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && React67.isValidElement(iconProp)) {
    icon = React67.cloneElement(iconProp, {
...
true ? Chip.propTypes = {
   ...
   */
  avatar: import_prop_types55.default.element,
  /**
   ...
   */
  clickable: import_prop_types55.default.bool,
  /**
   * The color of the component.
   * It supports both default and custom theme colors, which can be added as shown in the
   * [palette customization guide](https://mui.com/material-ui/customization/palette/#custom-colors).
   ...
   */
  deleteIcon: import_prop_types55.default.element,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
   ...
   * Icon element.
   */
  icon: import_prop_types55.default.element,
  /**
   * The content of the component.
   */
   ...
   */
  onDelete: import_prop_types55.default.func,
  /**
   * @ignore
   */
   ...
   * @default false
   */
  skipFocusWhenDisabled: import_prop_types55.default.bool,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'filled'
   */
  variant: import_prop_types55.default.oneOfType([import_prop_types55.default.oneOf(["filled", "outlined"]), import_prop_types55.default.string])
} : void 0;
...
var Tab = React71.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime53.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime53.jsxs)(React71.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime53.jsxs)(React71.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var Tabs = React76.forwardRef(function Tabs2(inProps, ref) {
  ...
  let childIndex = 0;
  const children2 = React76.Children.map(childrenProp, (child) => {
...
//# sourceMappingURL=chunk-PHMWLGGZ.js.map
